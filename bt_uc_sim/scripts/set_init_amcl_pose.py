...
# taken and edited from https://github.com/sea-bass/turtlebot3_behavior_demos/blob/main/tb3_worlds/launch/tb3_demo_world.launch.py
"""
...
class InitPosePublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("x", value=1.0)
        self.declare_parameter("y", value=2.0)
        self.declare_parameter("theta", value=0.0)
        self.declare_parameter("cov", value=0.1**2)
